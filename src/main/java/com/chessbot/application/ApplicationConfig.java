...
public final class ApplicationConfig {
    ...
    public static final int WHITE_PLAYER_TYPE = PlayerType.ENGINE;
    ...
    public static final Chessbot INITIAL_WHITE_BOT = new CurrentVersionBot("v2 - Alpha Beta Pruning");
    public static final Chessbot INITIAL_BLACK_BOT = new CurrentVersionBot("v2 - Alpha Beta Pruning");

    // The search depth that the different bot versions target. The search can exceed this number
    public static final int TARGET_SEARCH_DEPTH = 4;
