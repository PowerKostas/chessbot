...
// starting square, the next 6 for the ending square and the next 4 for the moveFlag (quiet, double pawn push, ...). In the 4
// bits that represent moveFlag, the 4th bit indicates a promotion, the 3rd bit indicates a capture and the 2nd and 1st bits
// are special bits
