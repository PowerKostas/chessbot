...
import com.chessbot.PieceUtils.PawnEnPassant;
...
public class Pawn extends Piece {
    ...
    // Because pawn pseudo legal moves and pawn en passant generate differently based on colour, to avoid an if in the
    // calculations, we put the 2 functions in an array. We separate normal moves and en passant moves, because there are
    // instances that en passant moves don't need to be generated
    ...
    public static final PawnEnPassant[] enPassant = new PawnEnPassant[] {Pawn::whiteEnPassant, Pawn::blackEnPassant};

    public static long whitePseudoLegalMoves(long pawnsBitboard, long allPiecesBitboard, long opponentBitboard) {
    ...
    public static long whiteEnPassant(long pawnsBitboard, long enPassantSquareBitboard) {
    ...
    public static long blackPseudoLegalMoves(long pawnsBitboard, long allPiecesBitboard, long opponentBitboard) {
        // 1. Moves the pawn up 1 square, if there are no pieces there
    ...
    public static long blackEnPassant(long pawnsBitboard, long enPassantSquareBitboard) {
